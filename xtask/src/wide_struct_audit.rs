...
//!
//! Scans all `.rs` files under `crates/` and `pyo3/` for structs with ≥10
...
// Updated 2026-03-21: allowances reflect current struct locations and sizes.
const WIDE_STRUCT_ALLOWANCES: &[WideStructAllowance] = &[
    ...
    WideStructAllowance {
        path: "crates/batchalign-app/src/transcribe/types.rs",
    ...
    // New entries (discovered during migration)
    WideStructAllowance {
        path: "crates/batchalign-app/src/worker/handle/config.rs",
        struct_name: "WorkerConfig",
        max_fields: 12,
        max_bool_fields: 1,
        disposition: WideStructDisposition::RealAggregate,
        reason: "worker spawning configuration aggregate",
    },
    WideStructAllowance {
        path: "crates/batchalign-app/src/worker/pool/mod.rs",
        struct_name: "PoolConfig",
        max_fields: 13,
        max_bool_fields: 1,
        disposition: WideStructDisposition::RealAggregate,
        reason: "worker pool configuration aggregate",
    },
    WideStructAllowance {
        path: "crates/batchalign-cli/src/args/commands.rs",
        ...
        max_bool_fields: 2,
        disposition: WideStructDisposition::BoundaryShim,
        reason: "clap boundary type for serve start command",
    },
    WideStructAllowance {
        path: "crates/batchalign-cli/src/dispatch/mod.rs",
        struct_name: "DispatchRequest",
        max_fields: 17,
        max_bool_fields: 3,
        disposition: WideStructDisposition::RealAggregate,
        reason: "aggregated request context for CLI dispatch",
    },
    WideStructAllowance {
        path: "crates/batchalign-cli/src/tui/app.rs",
        struct_name: "FileState",
        max_fields: 11,
        max_bool_fields: 0,
        disposition: WideStructDisposition::RealAggregate,
        reason: "per-file TUI state snapshot",
    },
];
