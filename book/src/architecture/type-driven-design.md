...
[`batchalign-types/src/macros.rs`](/Users/chen/batchalign3-rearch/crates/batchalign-types/src/macros.rs).
...
| `AsrTimestampSecs` | `f64` | `batchalign-chat-ops/src/asr_postprocess/asr_types.rs` | Raw ASR provider timestamp (seconds) |
| `SpeakerIndex` | `usize` | `batchalign-chat-ops/src/asr_postprocess/asr_types.rs` | Zero-based speaker index in a recording |
...
`crates/batchalign-app/src/types/worker.rs`) must produce JSON identical to the
