...
export interface components {
    schemas: {
        ...
        HealthResponse: {
             ...
             */
            build_hash?: string;
            /** @description Utterance cache backend in use: `"sqlite"` (default) or `"redis"`. */
            ...
            redis_cache_connected?: boolean;
            /**
             * @description Whether Redis cache support is configured (a `redis_url` is set
             *     in `server.yaml`).
             */
